...
<body>
    ...
    <div class="row center" style="margin-top: 150px;">
        <div class="col-4 col-s-4">
            <img src="images/porkcut.jpg" alt="Pork meat">
        </div>

        <div class="col-7 col-s-7">
            <p class="brand">No name</p>
            <p class="product">Pork meat</p>
            ...
            <form action="" method="post">
                ...
                <br>
                <input type="hidden" value="Pork Meat" name="name">
            ...
            <hr>
            <br>
            <p class="description" id="moreDescription">Pork meat from your beloved Canadian farms !help local economy!<br>
                <br><b>Origin:</b>Canada<br>
                <br>Product number: 25000</p>
            <hr>
            </p>
