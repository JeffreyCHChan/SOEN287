...
<body onload="cokeQuantityCheck(), cokeCost()">
    ...
    <div class="row center" style="margin-top: 150px;">
        ...
        <div class="col-7 col-s-7 spacing">
            <p class="brand">Brand: Coca-Cola Co.</p>
            <p id="productName" class="product">12-Pack Coca-Cola</p>
            <p class="price">price: $5.05 ea.</p>
            ...
            <p id="sub-total" onload="cost()"><span class="sub-total"><b>Sub-Total: </b></span> $5.05</p>
            ...
            <div id="moreDescription" hidden>
                <p class="description">Have a signature beverage from a company we all know.</p>
                <p class="description" align="left"><b>Origin</b>: Canada
                    <br>Product number: 63495</p>
                <p hidden id="productNumber">63495</p>
                </p>
            </div>
        </div>
    </div>
