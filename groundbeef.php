...
<body>
    ...
    <div class="row center" style="margin-top: 150px;">
        <div class="col-4 col-s-4">
            <img src="images/groundbeef.jpg" alt="ground beef">
        </div>

        <div class="col-7 col-s-7">
            <p class="brand">Behind meat</p>
            <p class="product">Ground beef</p>
            <p class="price"><del>$11.99 ea.</del></p>
            <p class="price" id="unit" style="color: red;">$10.99 ea.</p>
            <p class="avg-price"><del>$2.40 /100g</del></p>
            <p class="avg-price" style="color: red;">$2.20 /100g</p>
            <br>
            <form action="" method="post">
                    <label for="quantity" class="Quantity">Quantity:</label>
                    <input type="number" min="1" value="1" size="2" name="Quantity" id="quantity">
                <br>
                    <input type="hidden" value="Ground Beef" name="name">
            ...
            <hr>
            <br>
            <p class="description" id="moreDescription">Ground beef from your beloved Canadian farms !help local economy!<br>
                <br><b>Origin:</b>Canada<br>
                <br>Product number: 25002</p>
            </p>
            <hr>
        </div>
    </div>
